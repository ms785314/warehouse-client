            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center text-white font-bold text-2xl">
                  <span className='text-yellow-300'>B</span>ook<span className='text-yellow-300'>B</span>ucket
                </div>
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? 'bg-gray-900 text-xl text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                {/* if user logged in */}
                {user && <button className='text-xl text-white font-bold' onClick={handleSignOut}>Log Out</button>}
              </div>
            </div>
          </div>
